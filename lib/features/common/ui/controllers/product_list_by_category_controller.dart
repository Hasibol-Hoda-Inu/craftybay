...
class ProductListByCategoryController extends GetxController{
  ...
  Future<bool> getProductListByCategoryId(int categoryId)async{
    bool isSuccess = false;
    _inProgress = true;
    update();
    
    final NetworkResponse response = await Get.find<NetworkCaller>().getRequest(Urls.productListByCategory(categoryId));
